 ...
 * could never catch a regression in the code under review (and Cloudflare often
 * served a challenge page to GitHub-hosted runners). Serving the working tree
 * locally - with the real CSP and 404 rewrite applied - makes the suite
