 ...
 *
 * staticwebapp.config.json serves styles.css and script.js with max-age=86400,
 * and favicon.svg / images with a long-lived cache, while index.html is cached
 * for only 30 seconds. `immutable` is a
